...
namespace Xamarin.Forms.SegmentedButton
{
    ...
    {
        public static readonly BindableProperty DefaultColorProperty = BindableProperty.Create("DefaultColor", typeof(Color), typeof(SegmentedButtonControl), Color.Blue);
        ...
        public static readonly BindableProperty SelectedColorProperty = BindableProperty.Create("SelectedColor", typeof(Color), typeof(SegmentedButtonControl), Color.White);
        ...
        public static readonly BindableProperty CornerRadiusProperty = BindableProperty.Create("CornerRadius", typeof(int), typeof(SegmentedButtonControl), 0);
